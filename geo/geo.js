...
function on_success(pos)
{
	...
	var map_str = "https://maps.googleapis.com/maps/api/staticmap?"+ "center=" + pos.coords.latitude + "," +pos.coords.longitude+"&zoom=17&size=400x300&maptype=satellite&key=AIzaSyDKD7qEZBABLqaAgE3y6JN5TqotyJbC5d4";
